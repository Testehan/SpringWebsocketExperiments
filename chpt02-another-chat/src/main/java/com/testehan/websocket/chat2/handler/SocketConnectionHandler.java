package com.testehan.websocket.chat2.handler;
...
public class SocketConnectionHandler extends TextWebSocketHandler {
    ...
    // It will have a session info who is sending the message and also the Message object passes as parameter
    @Override
    public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {

        super.handleMessage(session, message);

        // Iterate through the list and pass the message to all the sessions...but ignore the session in the list
